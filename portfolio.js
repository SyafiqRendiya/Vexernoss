 ...
 * FIXED: YouTube real thumbnails + Better mobile
 */
...
// Create project HTML element - FIXED THUMBNAILS
function createProjectElement(project, index) {
    ...
    // Fallback jika thumbnail YouTube gagal
    const fallbackThumbnail = 'https://images.unsplash.com/photo-1611224923853-80b023f02d71?w=400&h=225&fit=crop';
    ...
    element.innerHTML = `
        ...
        <div class="portfolio-img" onclick="${clickAction}">
            <img src="${thumbnailUrl}" alt="${project.title}" loading="lazy" onerror="this.src='${fallbackThumbnail}'">
...
// Extract YouTube ID from URL - IMPROVED
